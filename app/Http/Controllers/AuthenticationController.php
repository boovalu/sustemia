   ...
   */ 
    ...
    public function processLogin(Request $request)
    {
        ...
        if ($user->role->name === 'admin') {
            return redirect()->route('dashboards.admin')->with('success', '¡Hola ' . $user->name . '! Has iniciado sesión con éxito.');
        }
    
        // Aquí puedes manejar otros roles si es necesario
        return redirect()->route('profile.view')->with('success', '¡Hola ' . $user->name . '! Has iniciado sesión con éxito.');
    }
