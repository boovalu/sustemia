...
<head>
    ...
    <link rel="icon" type="image/png" href="<?php echo e(url('css/imgs/favicon-32x32.png')); ?>">
...
<header>
    <nav class="navbar navbar-expand-lg navbar-light bg-white shadow-sm">
        <div class="container-fluid">
            ...
            <a class="navbar-brand text-dark" href="<?php echo e(url('/')); ?>">
                <img src="<?php echo e(url('css/imgs/resource/sustemia_oficial.png')); ?>" alt="Logo de Sustemia" height="50">
            </a>
            ...
            <div class="d-flex align-items-center ms-auto">
                <?php if(auth()->guard()->check()): ?>
                    <div class="dropdown">
                        <button class="btn btn-outline-success dropdown-toggle d-flex align-items-center" type="button" id="profileDropdown" data-bs-toggle="dropdown" aria-expanded="false">
                            <span class="material-icons me-2">account_circle</span> <?php echo e(auth()->user()->name); ?>

                        </button>
                        <ul class="dropdown-menu dropdown-menu-end p-2" aria-labelledby="profileDropdown">
                            <li>
                                <a class="dropdown-item" href="<?php echo e(route('profile.view')); ?>">
                ...
                <?php else: ?>
                    <a class="btn btn-outline-success me-2" href="<?php echo e(route('auth.login')); ?>">Iniciar Sesión</a>
                <?php endif; ?>
            </div>
        </div>
    </nav>
    ...
    <main class="sidebar__content d-flex flex-column" id="mainContent">
        <section class="col-md-12">
            <?php if(Session::has('success') || Session::has('warning') || Session::has('error')): ?>
    ...
    <footer class="page-footer py-4 text-white text-center" style="background-color: #107033;">
        ...
        <div class="d-flex justify-content-center flex-wrap">
            <img src="<?php echo e(url('css/imgs/acreditaciones/Logo_ITC.png')); ?>" class="img-fluid mx-2 rounded-img" alt="Logo ITC">
            <img src="<?php echo e(url('css/imgs/acreditaciones/Logo_iso_45001.png')); ?>" class="img-fluid mx-2 rounded-img" alt="Logo ISO 45001">
            <img src="<?php echo e(url('css/imgs/acreditaciones/logo_iso14001.png')); ?>" class="img-fluid mx-2 rounded-img" alt="Logo ISO 14001">
            <img src="<?php echo e(url('css/imgs/acreditaciones/Logo_SAI.png')); ?>" class="img-fluid mx-2 rounded-img" alt="Logo SAI">
        </div>
        <div class="py-2 fw-bold">
            &copy; <?php echo e(date('Y')); ?> SUSTEMIA
        </div>
...
<?php /**PATH C:\xampp\htdocs\ProyectoFinal\sustemia\resources\views/layouts/main.blade.php ENDPATH**/ ?>